...
<script>
    ...
    layui.use(['form','laydate','layer','table','tree'], function() {
        ...
        table.render({
            ...
            ,width : 1270
            ,height: 373
            ,url: '${pageContext.request.contextPath}/CmfzLog/selectAll'
            ,page: true //开启分页
            ,limit:6
            ,limits:[5,6,10]
            ,toolbar:"#toolbar"
        ...
        // private String logType;
                ...
                {type:'checkbox'}
                ,{field: 'logId', title: '日志ID',align:'center', sort: true/*, fixed: 'left'*/}
                ,{field: 'username', title: '管理员名字' ,align:'center'}
                ,{field: 'logIp', title: 'IP地址' ,align:'center'}
                ,{field: 'logDate', title: '操作时间' ,align:'center'}
                ,{field: 'logType', title: '操作类型' ,align:'center'}
                ,{field: 'logContent', title: '操作描述' ,align:'center'}
