...
<script>
    ...
    layui.use(['form','laydate','layer','table','tree'], function() {
        ...
        table.render({
            ...
            ,width : 1270
            ,height: 400
            ,url: '${pageContext.request.contextPath}/User/selectAllCmfzRoleResource'
            // ,page: true //开启分页
            // ,limit:6
            // ,limits:[5,6,10]
            ,toolbar:"#toolbar"
            ,cols: [[ //表头
                ...
                {type:'checkbox'}
                ,{field: 'roleId', title: '角色ID',align:'center', sort: true/*, fixed: 'left'*/}
                ,{field: 'roleName', title: '角色名字' ,align:'center'}
                ,{field: '', title: '角色' ,align:'center',templet:function(d){
                    console.log(d.cmfzRoleResourceList);
                    var html="";
                    for(var i=0;i<d.cmfzRoleResourceList.length;i++){
                            html+=d.cmfzRoleResourceList[i].cmfzResource.title+" ";
                    }
                    return html;
                    }}
