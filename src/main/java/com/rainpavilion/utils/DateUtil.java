...
public class DateUtil{
 ...
 /*
    ...
    //获取当天最大时间 或 最小时间
    public static Long formatDateToLong(String dateStr,String originalFormat,int type){
        ...
        try{
            ...
            if(type == 1){
                dateLong = LocalDateTime.of(localDate, LocalTime.MIN).toInstant(ZoneOffset.of("+8")).toEpochMilli();
            }else {
                dateLong = LocalDateTime.of(localDate,LocalTime.MAX).toInstant(ZoneOffset.of("+8")).toEpochMilli();
            }
        }catch (ParseException e){}
        return dateLong;
    }
